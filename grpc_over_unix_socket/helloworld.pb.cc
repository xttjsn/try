...
const ::google::protobuf::uint32 TableStruct_helloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloReply, msg_),
};
...
::google::protobuf::internal::DescriptorTable descriptor_table_helloworld_2eproto = {
  ...
  "helloworld.proto", &assign_descriptors_table_helloworld_2eproto, 170,
};
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("helloworld.HelloReply.msg");
